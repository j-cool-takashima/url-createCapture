...
const launchBrowser = async () => {
  ...
  console.log('[DEBUG] Launching Chromium from:', executablePath);
  console.log('[DEBUG] LD_LIBRARY_PATH:', process.env.LD_LIBRARY_PATH || '(not set)');
  ...
  try {
    ...
    console.error('[ERROR] Puppeteer launch failed:', error.message);
